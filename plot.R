...
srmi<- read.csv('/Users/dsuolang/Desktop/study2/HPC_results/srmi/result_sheet_srmi.csv')
srmi$method = 'REG'
pmm <- read.csv('/Users/dsuolang/Desktop/study2/HPC_results/pmm/result_sheet_pmm.csv')
...
# Part 4: Log Models Analysis

# Load Data
srmi <- read.csv('/Users/dsuolang/Desktop/study2/HPC_results/srmi/log_result_diabetes.csv')
srmi$method <- 'REG'

pmm <- read.csv('/Users/dsuolang/Desktop/study2/HPC_results/pmm/log_result_diabetes.csv')
pmm$method <- 'PMM'
...
# Part 3 : coverage
srmi<- read.csv('/Users/dsuolang/Desktop/study2/HPC_results/srmi/result_sheet_srmi.csv')
srmi<- read.csv('/Users/dsuolang/Desktop/study2/HPC_results/srmi/accuracy_df.csv')
srmi$method = 'REG'
pmm <- read.csv('/Users/dsuolang/Desktop/study2/HPC_results/pmm/result_sheet_pmm.csv')
pmm<- read.csv('/Users/dsuolang/Desktop/study2/HPC_results/pmm/accuracy_df.csv')
pmm<-pmm[pmm$model_spec=="w/o_Transf",]
pmm$method = 'PMM'
srmi_pmm<-rbind(srmi, pmm)
...
df_clean$miss_rate <- as.numeric(df_clean$miss_rate)
